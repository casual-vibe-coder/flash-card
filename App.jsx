...
const SERIES_LABELS={ [BYY1_SERIES]:"Bayna Yadayk — Book 1, Part 1", [BYY1P2_SERIES]:"Bayna Yadayk — Book 1, Part 2", [BYY2P1_SERIES]:"Bayna Yadayk — Book 2, Part 1", [BYY2P2_SERIES]:"Bayna Yadayk — Book 2, Part 2" };
const PRESET_DECKS=[
