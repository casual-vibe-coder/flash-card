// image.js — Vercel serverless function (duplicate of api/image.js for routing)
// Proxies Gemini "Nano Banana" (gemini-2.5-flash-image) image generation.
// Returns the image as a base64 data URL in DALL-E-compatible shape: { data: [{ url }] }.
